...
from src.config import URL_EMPLOYERS, EMPLOYERS_ID, PARAMS, config, DATABASE_NAME
...
class Employers:
    ...
    def __init__(self):
        self.employers_id_list = [employer['id'] for employer in
                                  EMPLOYERS_ID]  # Получение ID работодателей
        self.employers_list = EMPLOYERS_ID  # Получение ID и наименований работодателей
    ...
    def get_employer(cls, employer_id):
        ...
        url = URL_EMPLOYERS + str(employer_id)
