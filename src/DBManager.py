...
from src.config import DATABASE_NAME, config
...
class DBManager:
    ...
    def get_companies_and_vacancies_count(self):
        """Получает список всех работодателей и количество
        вакансий у каждого из них."""
    ...
    def get_all_vacancies(self):
        ...
        работодателя и вакансии, зарплаты и ссылки на вакансию."""
